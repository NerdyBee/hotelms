<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Laundry Service</div>
                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control" placeholder="Customer" value="Customer" name="customer" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-lg btn-success" name="createLaundryInvoice" style="border-radius:0%">New Service</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Laundry Invoices</div>
                <div class="panel-body">
                    <?php
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="rooms">
                        ...
                        <tbody>
                        <?php
                        $invoice_query = "SELECT * FROM laundry_invoice ORDER BY id desc";
                        ...
                        if (mysqli_num_rows($invoice_result) > 0) {
                            ...
                            while ($invoice = mysqli_fetch_assoc($invoice_result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="Edit LAundry Invoice" href="index.php?editLaundryInvoice&invoice=<?php echo $invoice['id']; ?>"
                                        ...
                                        <button title="View Laundry Service Content" style="border-radius:60px;" data-toggle="modal"
                                                data-target="#invoiceDetailsModal" data-id="<?php echo $invoice['id']; ?>"
                                                id="laundryInvoiceDetails" class="btn btn-warning"><i class="fa fa-eye"></i></button>
    ...
    <div id="invoiceDetailsModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-center"><b>Laundry Invoice Content</b></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
